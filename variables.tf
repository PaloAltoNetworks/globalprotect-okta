...
variable "demo_users" {
  description = <<-EOF
  A list of demo users to create in Okta. Each ite m in the list should have the following fields:
  - `first_name` (string): The first name of the user.
  - `las_tname` (string): The last name of the user.
  - `login` (string): The login username for the user.
  - `group` (string): The name of the group to which the user should be added. Note: The groups defined here will be automatically created in Okta.
  EOF
  default     = []
}
